          ...
          <div className="flex-1 custom-scrollbar overflow-y-auto flex flex-col min-h-0 relative">
            <div className="flex-1 flex flex-col w-full pt-0">
              <main className="flex-1 shrink-0 bg-transparent flex flex-col w-full relative z-0">
                ...
                <table className="print-layout-table w-full border-0 border-collapse m-0 p-0 bg-transparent">
                  ...
                  <tbody className="bg-transparent border-0">
                    <tr className="border-0 bg-transparent">
                      <td className="border-0 bg-transparent p-0">
                        <div className="print-layout-content w-full bg-transparent border-0">
                          <Outlet />
                        </div>
                      </td>
                    </tr>
              ...
              <footer className={`mt-8 shrink-0 py-3.5 flex flex-col items-center gap-0.5 text-center text-[#212c46] w-full bg-transparent transition-all duration-300 ${isModalOpen ? 'filter blur-[12px] opacity-40 pointer-events-none scale-[0.98]' : ''}`}>

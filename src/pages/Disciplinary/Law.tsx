...
const KpiCard = ({ icon: IconComp, value, label, colorAccent, desc }) => (
...
const UserGuidePanel = ({ isOpen, onClose }) => {
          ...
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 bg-gradient-to-tr from-[#b58c4f] to-[#f3e5ab] rounded-xl flex items-center justify-center text-[#212c46] shadow-inner p-[2px]">
                <div className="w-full h-full bg-[#0F172A] rounded-[10px] flex items-center justify-center">
                    <BookOpen size={18} className="text-[#b58c4f]"/>
                </div>
            </div>
            <div>
              <h3 className="text-sm font-black flex items-center gap-2 uppercase tracking-widest leading-none mb-1 drop-shadow-sm">REPOSITORY GUIDE</h3>
              <p className="text-[10px] font-bold text-[#748b9e] uppercase tracking-widest mt-1 drop-shadow-sm">คู่มือคลังระบบวินัยและกฎหมายแรงงานอย่างละเอียด</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-6 text-[#414757] text-[12px] leading-relaxed bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <ShieldAlert size={16} className="text-[#b22026]"/> 1. Document Class Definition (ประเภทเอกสารวินัย)
            </h4>
            <p className="mb-2 text-[#414757] font-medium text-[11.5px]">ระบบจัดสรรเอกสารอ้างอิงและกฎหมายออกเป็น 3 หมวดหมู่หลักแบบเฉพาะ:</p>
            <ul className="space-y-2 list-none pl-0 text-[11px] font-medium text-[#606a5f]">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-2.5 rounded-xl border border-[#eaeaec]">
                <div className="w-2 h-2 rounded-full bg-[#b22026] mt-1.5 shrink-0"/> 
                <div><strong>Company Regulations:</strong> ข้อบังคับและประกาศข้อกำหนดด้านเวลาทำงาน การลา สวัสดิการ และการลงโทษที่เป็นมาตรฐานของบริษัท</div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-2.5 rounded-xl border border-[#eaeaec]">
                <div className="w-2 h-2 rounded-full bg-[#3f809e] mt-1.5 shrink-0"/> 
                <div><strong>Labor Law:</strong> พรบ. และข้อบังคับกฎหมายแรงงานแห่งชาติ มาตราสำคัญ รวมถึงประกาศจากกรมสวัสดิการและคุ้มครองแรงงาน</div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-2.5 rounded-xl border border-[#eaeaec]">
                <div className="w-2 h-2 rounded-full bg-[#a94228] mt-1.5 shrink-0"/> 
                <div><strong>Disciplinary Actions:</strong> คู่มือและแนวกระบวนการทางวินัยพนักงาน การออกใบเตือนความผิด (Written Warning) ลำดับการตักเตือนจนถึงเลิกจ้าง</div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Paperclip size={16} className="text-[#b58c4f]"/> 2. File Attachments Registry (ระบบจัดการไฟล์แนบ)
            </h4>
            <div className="bg-[#f0f9f6] p-3.5 rounded-2xl border border-[#e2f0ee] space-y-1 text-[11px] text-[#606a5f] font-medium">
              <p>• สามารถจัดเก็บ อัปโหลด และลบไฟล์แนบที่เกี่ยวข้อง เช่น PDF ร่างกฎหมายฉบับย่อ ไฟล์ข้อเสนอแนะ แผนผังวิเคราะห์ หรือรูปภาพหลักฐานกระบวนการได้เอง</p>
              <p>• รองรับไฟล์ตระกูลเอกสารทั่วไป ไม่ว่าจะเป็นเอกสาร Word, ไฟล์บีบอัด หรือไฟล์รูปภาพ</p>
            </div>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Edit3 size={16} className="text-[#b58c4f]"/> 3. Operation Standard Nodes (ปุ่มควบรวมสิทธิ์ผู้ใช้งาน)
            </h4>
            <div className="grid grid-cols-1 gap-2.5">
              {[
                { icon: Edit3, label: 'Edit & Inspect Content', desc: 'เปิดแผ่นบันทึกข้อบังคับเพื่อแก้ไขเนื้อใน ปรับรุ่นการแก้ไข (v2.4) จัดการลิงค์เอกสาร และอัปโหลดไฟล์ได้อย่างไร้รอยต่อ', color: '#b58c4f' },
                { icon: Trash2, label: 'Delete Document Link', desc: 'ปลดล็อกและทำลายลิงก์เก็บบันทึกประวัติกฎหมายหรือระเบียบตัวอย่าง โดยมีกล่องตรวจสอบความปลอดภัยป้องกันการกดผิดพลาด', color: '#b22026' },
              ].map((btn, idx) => (
      ...
      <div className="px-4 sm:px-8 w-full mt-[2px]">
        <div className="w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-3 shrink-0">
                <KpiCard label="Repository Total" value={documents.length} icon={FileText} colorAccent={THEME.palette.cerulean} desc="Master Documents" />
                <KpiCard label="Enforced Policies" value={documents.filter(d => d.status === 'Active').length} icon={ShieldAlert} colorAccent={THEME.palette.forest} desc="Active Nodes" />
                <KpiCard label="Law Updates" value="3" icon={Scale} colorAccent={THEME.palette.burntOrange} desc="Amendments" />
                <KpiCard label="File Density" value={documents.reduce((acc, doc) => acc + (doc.attachments?.length || 0), 0)} icon={Paperclip} colorAccent={THEME.palette.slate} desc="Total Attachments" />
            </div>

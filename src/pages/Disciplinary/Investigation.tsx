...
const KpiCardCompact = ({ icon, value, label, colorAccent, colorValue, desc }: any) => (
  <div className="bg-white/90 px-4 py-3 rounded-2xl border border-[#eaeaec] shadow-xs flex-1 min-w-[200px] relative overflow-hidden group hover:border-[#b7a159] transition-all flex flex-col justify-between animate-fadeIn">
...
// --- User Guide Sidebar (ระบบบิวท์อินพอร์ท่อดึงข้อมูลแบบอธิบายละเอียด) ---
    ...
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-white shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-2 border-[#b7a159] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#b7a159] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-base"><Icons.BookOpen size={20} className="text-[#b7a159]" /> INVESTIGATION GUIDE</h3>
            <p className="text-[11px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1">วินัยและสืบสวนระเบียบข้อบังคับ</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[13px] font-black text-[#212c46] mb-2.5 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-1.5 font-sans">
              <Icons.ShieldAlert size={16} className="text-[#b7a159]" /> 1. Confidential & Chain of Evidence
            </h4>
            <p className="text-[11.5px] mb-2">ข้อมูลกระบวนการสอบสวนทางวินัยถือเป็นความลับสุดยอด (Confidential - Restricted Area Code) การเข้าถึงถูกควบคุมอย่างเข้มงวด:</p>
            <ul className="list-none pl-0 space-y-2">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-2.5 rounded-xl border border-[#eaeaec]">
                <Icons.EyeOff size={14} className="shrink-0 text-[#a94228] mt-0.5" />
                <div><strong className="text-[#212c46]">Information Security:</strong> สรุปผลสอบสวน ตัวคดี และหลักฐานแวดล้อมจะไม่ถูกเผยแพร่ในหน้าสารบรรณทั่วไป บอร์ดสืบสวนหรือฝ่ายบริหารที่เกี่ยวข้องเท่านั้นที่มีสิทธิ์ตรวจสอบ</div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-2.5 rounded-xl border border-[#eaeaec]">
                <Icons.Database size={14} className="shrink-0 text-[#657f4d] mt-0.5" />
                <div><strong className="text-[#212c46]">Appraisal Impact:</strong> ดัชนีการหักคะแนนพฤติกรรม (Behavior Point Deductions) จากการสืบสวนจะส่งข้อมูลเชื่อมตรงไปยังฝ่ายจ่ายเงินเดือนและระบบคะแนน KPI ประเมินโบัสและรายไตรมาสโดยทันที</div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[13px] font-black text-[#212c46] mb-2.5 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-1.5 font-sans">
              <Icons.FileText size={16} className="text-[#a94228]" /> 2. 5-Stage Investigation Procedure
            </h4>
            <p className="text-[11.5px] mb-2">ขั้นตอนกระบวนการของบอร์ดทดสอบสืบสวนวินัยพนักงานแบ่งเป็น 5 ระดับสถานะหลัก:</p>
            <ul className="space-y-1.5 pl-4 list-decimal text-[11.5px] text-[#414757]">
              <li><strong>Fact-Finding (รวบรวมหลักฐาน):</strong> ขั้นระบุข้อบังคับ สืบคดีทางระบบ เก็บรวบรวมไฟล์ log และข้อมูลกล้องวงจรปิด</li>
              <li><strong>Accusation (แจ้งข้อกล่าวหา):</strong> นัดพบพนักงานออกเอกสารชี้แจงเพื่อพิสูจน์ความผิดและเปิดโอกาสให้คัดค้านพยาน</li>
              <li><strong>Committee Review (ตรวจพิจารณา):</strong> งานพิจารณาโดยคณะกรรมการจากตัวแทนแผนก ตรวจสอบความถูกต้องอย่างชอบธรรม</li>
              <li><strong>Pending Resolution (รอคำสั่งบังคับ):</strong> ออกแถลงคำบังคับและสรุปบทลงโทษทางพฤติกรรมพนักงานอย่างเป็นรูปธรรม</li>
              <li><strong>Completed (ลงโทษเสร็จสิ้น):</strong> ส่งหนังสือคำสั่งลงนาม ประกาศใช้มาตรการทางวินัย และบันทึกประวัติพนักงาน</li>
            </ul>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[13px] font-black text-[#212c46] mb-2.5 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-1.5 font-sans">
              <Icons.ShieldCheck size={16} className="text-[#657f4d]" /> 3. System Synchronization Code
            </h4>
            <p className="text-[11.5px]">การเปลี่ยนแปลงข้อมูลทางวินัยทั้งหมดจะบันทึกรหัสล็อกไว้ในฐานประวัติดิจิทัลของฝ่ายความเสี่ยง และซิงค์ประวัติไปยังหน้าหลัก SMART LAW Node โดยเร็วที่สุดเพื่อความโปร่งใสตรวจสอบได้</p>
          </section>
        </div>
        
        <div className="p-4 bg-[#f8f9fa] border-t border-[#eaeaec] flex justify-end shrink-0">
          <button onClick={onClose} className="px-6 py-2 bg-[#212c46] text-white font-black rounded-xl uppercase text-[11px] hover:bg-[#414757] hover:text-white transition-all shadow-md tracking-wider">รับทราบคู่มือใช้งาน / ACKNOWLEDGE</button>
        </div>
      </div>
    </>, document.body
  );

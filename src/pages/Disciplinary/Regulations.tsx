...
// --- Comprehensive User Guide Panel (Identical standard to User Permissions) ---
    ...
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-white shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-2 border-[#b7a159] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#b7a159] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-lg"><BookOpen size={22} className="text-[#b7a159]"/> REGULATIONS GUIDE</h3>
            <p className="text-[11px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1.5">Company Rules & Code of Conduct Hub</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <ShieldAlert size={18} className="text-[#b58c4f]"/> 1. Work regulations (ข้อบังคับเกี่ยวกับการทำงาน)
            </h4>
            <p className="text-[12px] mb-3">คลังข้อมูลระบบข้อบังคับเกี่ยวกับการทำงานของ บริษัท ชัยศรี อะโกรอินดัสเทรียล จำกัด เพื่อความโปร่งใสและปฏิบัติตาม พรบ. คุ้มครองแรงงาน โดยแบ่งออกเป็น 11 หมวดหมู่สำคัญอย่างเป็นทางการ:</p>
            <ul className="list-none pl-0 space-y-2 max-h-[220px] overflow-y-auto custom-scrollbar pr-1">
              <li className="p-2 bg-[#f8f9fa] rounded-lg border border-[#eaeaec] text-[11px]">
                <strong className="text-[#212c46]">หมวด 1-3:</strong> บททั่วไป, การว่าจ้าง และวันทำงาน เวลาทำงานปกติ เวลาพัก
              </li>
              <li className="p-2 bg-[#f8f9fa] rounded-lg border border-[#eaeaec] text-[11px]">
                <strong className="text-[#212c46]">หมวด 4-5:</strong> วันลาและเกณฑ์การลา, วันหยุดและเกณฑ์วันหยุด
              </li>
              <li className="p-2 bg-[#f8f9fa] rounded-lg border border-[#eaeaec] text-[11px]">
                <strong className="text-[#212c46]">หมวด 6-7:</strong> เกณฑ์ทำงานล่วงเวลา/วันหยุด, วันและสถานที่จ่ายค่าจ้างและ OT
              </li>
              <li className="p-2 bg-[#f8f9fa] rounded-lg border border-[#eaeaec] text-[11px]">
                <strong className="text-[#212c46]">หมวด 8-9:</strong> วินัยและโทษทางวินัย, การร้องทุกข์
              </li>
              <li className="p-2 bg-[#f8f9fa] rounded-lg border border-[#eaeaec] text-[11px]">
                <strong className="text-[#212c46]">หมวด 10-11:</strong> การเลิกจ้าง/ชดเชยค่าเช่า, สภาพบังคับและการใช้กฎระเบียบ
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Paperclip size={18} className="text-[#a94228]"/> 2. Media & Attachments
            </h4>
            <p className="text-[12px] mb-3">ระบบการอัปโหลดไฟล์หลักฐาน สัญญา หรือข้อตกลงที่เกี่ยวข้อง:</p>
            <ul className="list-disc pl-5 mt-2 space-y-2 text-[12px]">
              <li><strong className="text-[#212c46]">Upload PDF / DOCX:</strong> อัปโหลดหนังสือทางการ ข้อเสนอแนะ หรือคำเตือนฉบับลงนาม</li>
              <li><strong className="text-[#3f809e]">Image Attachments:</strong> รองรับภาพถ่ายแผนผัง Flow-chart หรือรูปถ่ายหลักฐานการฝ่าฝืนทางวินัย</li>
              <li><strong className="text-[#657f4d]">Integrity Check:</strong> ทุกไฟล์จะถูกคำนวณขนาดและแสดงประเภทอย่างชัดเจนเพื่อความมั่นคงปลอดภัย</li>
            </ul>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Icons.RefreshCw size={18} className="text-[#3f809e]"/> 3. Version Control Node
            </h4>
            <p className="text-[12px]">การปรับปรุงเอกสารบริษัทจะมีระบบกำกับเลขรุ่น (Version Control) เพื่อติดตามความเปลี่ยนแปลง และป้องกันการใช้เอกสารกฎระเบียบที่ล้าสมัย โดยเจ้าหน้าที่สามารถระบุรุ่นควบคุมเพื่อรักษามาตรฐานคุณภาพ ISO-DCC ขององค์กร</p>
          </section>
        </div>
...
// --- Lean and High-Contract KPI Card System ---
const KpiCard = ({ icon: IconComp, value, label, colorAccent, desc }: any) => (
  <div className="bg-white px-4 py-3 rounded-xl border border-[#eaeaec] shadow-sm flex-1 min-w-[200px] relative overflow-hidden group hover:border-[#b7a159] transition-all flex flex-col justify-between min-h-[95px] animate-fadeIn">
    <div className="absolute -right-3 -bottom-5 opacity-[0.05] transform group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-700 pointer-events-none">
      <IconComp size={70} color={colorAccent} strokeWidth={2} />
    </div>
    <div className="relative z-10 flex justify-between items-start w-full">
      <p className="text-[10px] font-black text-[#7a8b95] uppercase tracking-[0.1em]">{label}</p>
      <div className="w-7 h-7 rounded-lg border flex items-center justify-center shrink-0 shadow-sm transition-all text-[11px]" style={{backgroundColor: `${colorAccent}12`, borderColor: `${colorAccent}22`, color: colorAccent}}>
        <IconComp size={14} strokeWidth={2.5} />
      </div>
    </div>
    <div className="relative z-10 mt-1 flex items-end justify-between">
      <p className="text-[20px] font-black leading-none text-[#212c46]">
        {value}
      </p>
      <span className="text-[9px] font-bold text-[#4d87a8] uppercase tracking-widest flex items-center gap-1 font-mono">
      ...
      <div className="px-4 sm:px-8 w-full mt-[2px]">
        <div className="w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-3 shrink-0">
                <KpiCard label="Repository Total" value={documents.length} icon={FileText} colorAccent={THEME.primary} desc="Master Documents" />
                <KpiCard label="Enforced Policies" value={documents.filter(d => d.status === 'Active').length} icon={ShieldAlert} colorAccent={THEME.success} desc="Active Nodes" />
                <KpiCard label="Critical Updates" value="2" icon={History} colorAccent={THEME.accent} desc="Amendments" />
                <KpiCard label="File Density" value={documents.reduce((acc, doc) => acc + (doc.attachments?.length || 0), 0)} icon={Paperclip} colorAccent={THEME.skyBlue} desc="Total Attachments" />
            </div>

            {/* MAIN CONTENT AREA */}
            <div className="bg-white/90 rounded-3xl border border-[#eaeaec] overflow-hidden flex flex-col animate-fadeIn">

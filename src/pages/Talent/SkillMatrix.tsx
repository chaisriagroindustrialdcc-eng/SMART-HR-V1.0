        ...
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#b7a159] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-lg">
              <BrainCircuit size={22} className="text-[#b7a159]"/> TALENT SKILL GUIDE
            </h3>
            <p className="text-[12px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1.5">Competency & Matrix Manual</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <ShieldCheck size={18} className="text-[#b7a159]"/> 1. COMPREHENSIVE SKILL SCORING
            </h4>
            <p className="text-[12px] mb-3">ระบบกำหนดคะแนนทักษะในคลังความสามารถเพื่อจำแนกศักยภาพพนักงานตามแนวคิด ISO/GMP:</p>
            <ul className="list-none pl-0 space-y-3">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <span className="w-5 h-5 rounded bg-[#212c46] text-white flex items-center justify-center font-mono text-[10px] shrink-0 font-bold">1</span>
                <div>
                  <strong className="text-[#212c46]">ระดับ 1-2 (Basic/Developing):</strong> มีความรู้เบื้องต้น กำลังพัฒนาทักษะ มีข้อจำกัดในการรับปริมาณงานด้วยตนเอง
                </div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <span className="w-5 h-5 rounded bg-[#212c46] text-white flex items-center justify-center font-mono text-[10px] shrink-0 font-bold">3</span>
                <div>
                  <strong className="text-[#212c46]">ระดับ 3 (Autonomous Specialist):</strong> ทำงานได้ตรงตามมาตรฐาน ปฏิบัติงานจริงหน้างานอุตสาหกรรมด้วยตัวเองอย่างถูกต้อง
                </div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <span className="w-5 h-5 rounded bg-[#212c46] text-white flex items-center justify-center font-mono text-[10px] shrink-0 font-bold">4-5</span>
                <div>
                  <strong className="text-[#212c46]">ระดับ 4-5 (Expert / Mentor):</strong> มีความเชี่ยวชาญพิเศษ วางกลยุทธ์แก้ปัญหาวิกฤต และสามารถสอนงานให้พนักงานใหม่ตามคู่มือ SOP ได้
                </div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Layers size={18} className="text-[#b7a159]"/> 2. COMPETENCY ROADMAP SORTS
            </h4>
            <p className="text-[12px] mb-3">ทักษะที่นำมาคำนวณแยกส่วนแบ่งออกเป็น 4 ขอบเขตความรู้หลัก:</p>
            <div className="space-y-3 pl-2 text-[11px]">
              <p>📍 <strong className="text-[#a94228]">Technical:</strong> ทักษะระบบเครื่องจักร ซอฟต์แวร์ และโครงสร้างตามลักษณะสายงานวิศวกรรม/ปฏิบัติการ</p>
              <p>📍 <strong className="text-[#3f809e]">Communication:</strong> ความถูกต้องในการประสานข้อมูลและรายงานสภาวะขัดข้อง</p>
              <p>📍 <strong className="text-[#b58c4f]">Leadership:</strong> ทัศนคติการคุมกำลังพล และแผนการปฏิบัติตามมาตรฐานแรงงานสัมพันธ์</p>
              <p>📍 <strong className="text-[#657f4d]">Problem Solving:</strong> ความโดดเด่นในการตัดสินใจและแก้ไขปัญหาเฉพาะหน้า</p>
            </div>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.15s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Lock size={18} className="text-[#932c2e]"/> 3. SYNCHRONIZATION AND EDITING
            </h4>
            <p className="text-[12px] font-bold text-[#2f2926] bg-[#932c2e]/10 border border-[#932c2e]/30 p-3 rounded-xl leading-relaxed">
              สิทธิ์ในการประเมินและอนุมัติความสอดคล้อง (Approve) จะถูกควบคุมตามนโยบายรักษาความลับส่วนบุคคล ผู้กุมสิทธิ์ที่ผ่านการตรวจสอบจากกล่อง User Permissions เท่านั้นที่จะได้รับสิทธิ์อัปโหลดหรือแก้ไขเกณฑ์เหล่านี้
            </p>
          </section>
        </div>
...
// --- Lean KPI Card styled neatly for the overall view with tight padding ---
const KpiCard = ({ iconName, value, label, colorAccent, colorValue, desc }: any) => {
  const IconComp = iconName === 'Award' ? Award :
                   iconName === 'UserCheck' ? UserCheck :
                   iconName === 'BarChart3' ? BarChart3 : AlertTriangle;
  return (
    <div className="bg-white px-4 py-3.5 rounded-2xl border border-[#eaeaec] shadow-sm flex-1 min-w-[200px] relative overflow-hidden group hover:border-[#b7a159] transition-all min-h-[90px] flex flex-col justify-between animate-fadeIn cursor-default">
      <div className="absolute -right-4 -bottom-6 opacity-[0.05] transform group-hover:scale-110 transition-transform duration-700 pointer-events-none">
        <IconComp size={85} color={colorAccent} strokeWidth={1.5} />
      </div>
      <div className="relative z-10 flex justify-between items-start w-full">
        <p className="text-[10px] font-bold text-[#7a8b95] uppercase tracking-[0.1em]">{label}</p>
        <div className="w-7 h-7 rounded-lg border flex items-center justify-center shrink-0 shadow-sm transition-all group-hover:rotate-6" style={{ backgroundColor: `${colorAccent}12`, borderColor: `${colorAccent}22`, color: colorAccent }}>
          <IconComp size={14} />
        </div>
      </div>
      ...
      <div className="px-4 sm:px-8 w-full mt-[2px]">
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-3 shrink-0">
            <KpiCard label="Average Group Score" value={kpiData.avg} iconName="BarChart3" colorAccent={THEME.skyBlue} colorValue={THEME.primary} desc="Across Assessed Users" />
            <KpiCard label="Promotion Success Track" value={kpiData.promotion} iconName="Award" colorAccent={THEME.gold} colorValue={THEME.primary} desc="Exceeds Core Competence" />
            <KpiCard label="Stable Performers" value={kpiData.stable} iconName="UserCheck" colorAccent={THEME.success} colorValue={THEME.success} desc="Certified Talent" />
            <KpiCard label="Functional Candidates" value={kpiData.total} iconName="AlertTriangle" colorAccent={THEME.accent} colorValue={THEME.primary} desc="Managed Profiles" />
          </div>

          {activeTab === 'registry' ? (
            <div className="bg-white rounded-3xl shadow-lg border border-[#eaeaec] overflow-hidden flex flex-col mb-8 mt-4 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start mt-4 animate-fadeIn">
          ...
          {/* Footer margin spacing helper standard matching `mt-8` / `mb-8` (32px) */}

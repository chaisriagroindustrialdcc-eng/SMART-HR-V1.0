    ...
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-white shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-2 border-[#b58c4f] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#b58c4f] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-lg"><BookOpen size={22} className="text-[#b7a159]"/> JOB OPENINGS GUIDE</h3>
            <p className="text-[12px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1.5">Vacancy & Recruitment Management</p>
          </div>
          <button onClick={onClose} className="p-2 text-white/55 hover:text-[#932c2e] hover:bg-white/10 rounded-xl transition-colors"><X size={24}/></button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Compass size={18} className="text-[#a94228]"/> 1. Recruitment Life-Cycle (วงจรชีวิตการสรรหา)
            </h4>
            <p className="text-[12px] mb-3">แต่ละตำแหน่งจะมีประวัติการรับสมัครและสถานะที่แตกต่างกันตามกระบวนการสรรหา:</p>
            <ul className="list-none pl-0 space-y-3">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <FileText size={16} className="shrink-0 text-[#b58c4f] mt-0.5"/> 
                <div><strong className="text-[#b58c4f]">Draft (แบบร่าง):</strong> บันทึกรายละเอียดตำแหน่งล่วงหน้าก่อนเผยแพร่จริง โดยยังไม่แสดงบนเว็บสมัครงานภายนอก เพื่อให้ฝ่ายจัดซื้อจัดจ้างวางแผนร่วมกัน</div>
              </li>
              <li className="flex items-start gap-2 bg-[#657f4d]/10 p-3 rounded-xl border border-[#657f4d]/30">
                <Globe size={16} className="shrink-0 text-[#657f4d] mt-0.5"/> 
                <div><strong className="text-[#657f4d]">Published (เผยแพร่ใช้งาน):</strong> ตำแหน่งขึ้นแสดงเป็นสาธารณะ พร้อมเปิดระบบรับเอกสารและเปิด API รับใบสมัครจากภายนอก</div>
              </li>
              <li className="flex items-start gap-2 bg-[#932c2e]/10 p-3 rounded-xl border border-[#932c2e]/30">
                <XCircle size={16} className="shrink-0 text-[#932c2e] mt-0.5"/> 
                <div><strong className="text-[#932c2e]">Closed (ปิดรับสมัคร):</strong> ปิดตำแหน่งงานเรียบร้อยหลังจากเสร็จสิทธิ์ได้คนครบตามแผนกำลังคนที่อนุมัติแล้วชั่วคราว</div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Target size={18} className="text-[#3f809e]"/> 2. HR Budget & Scope Control (ควบคุมโควต้าและงบประมาณ)
            </h4>
            <p className="text-[12px] mb-3">ระบบคำนวณและจำกัดงบประมาณจำนวนบุคลากรผ่านระบบความเชื่อมโยง:</p>
            <ul className="list-disc pl-5 mt-2 space-y-2 text-[12px]">
              <li><strong className="text-[#212c46]">Manpower Planning Check:</strong> เปรียบเทียบตำแหน่งงานและจำนวนเป้าหมาย Headcount กับโควตาในงบประจำปีของแต่ละทีมโดยตรง</li>
              <li><strong className="text-[#212c46]">JD Repository Integration:</strong> โหลดข้อมูลรายละเอียดและคุณสมบัติพนักงานแมนนวลจากคลังข้อมูลกลาง เพื่อลดเวลาป้อนข้อมูล</li>
              <li><strong className="text-[#212c46]">Application Counters:</strong> ระบบนับใบสมัครที่เชื่อมการทำงานสองทางกับระบบคลาวด์ ATS Tracking อย่างต่อเนื่อง</li>
            </ul>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Sliders size={18} className="text-[#657f4d]"/> 3. Settings & Controls (การควบคุมระบบ)
            </h4>
            <p className="text-[12px]">ผู้ดูแลระบบสามารถสลับหน้าต่าง <b>Hiring Settings</b> เพื่อตรวจสอบขอบเขตระบบการอนุมัติแบบอัตโนมัติ การล็อกข้อมูลชั่วคราวฉุกเฉิน และอัปเดตระยะเวลารับสมัครงานเฉลี่ยอย่างทันใจ</p>
          </section>
        </div>
        
        <div className="p-4 bg-[#f8f9fa] border-t border-[#eaeaec] flex justify-end shrink-0">
          <button onClick={onClose} className="px-8 py-2.5 bg-[#212c46] text-white font-black rounded-xl uppercase text-[12px] hover:bg-[#a94228] transition-all shadow-md tracking-[0.1em]">รับทราบ (Got it)</button>
        </div>
      </div>
    </>, document.body
  );
...
const Toast = ({ message, type = 'success', onClose }: { message: string; type?: 'success' | 'error'; onClose: () => void }) => (
  createPortal(
    <div className="fixed bottom-6 right-6 z-[1000] animate-slideInRight flex items-center gap-3 bg-white px-5 py-3.5 rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-[#eaeaec]">
      <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${type === 'success' ? 'bg-[#508660]/10 text-[#508660]' : 'bg-[#b22026]/10 text-[#b22026]'}`}>
      ...
      <button onClick={onClose} className="ml-4 text-[#7a8b95] hover:text-[#2f2926]"><X size={14} /></button>
    </div>,
    document.body
  )
);
...
const DeleteConfirmModal = ({ isOpen, onClose, onConfirm }: { isOpen: boolean; onClose: () => void; onConfirm: () => void }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-[#2f2926]/70 backdrop-blur-sm p-4 animate-fadeIn">
...
const KpiCard = ({ icon: IconComp, value, label, colorAccent, colorValue, desc }: any) => (
  <div className="bg-white/95 backdrop-blur-md px-5 py-4 rounded-[24px] border border-[#939885]/20 shadow-[0_8px_30px_rgba(47,41,38,0.04)] flex-1 min-w-[200px] relative overflow-hidden group hover:border-[#b58c4f]/40 hover:shadow-[0_8px_30px_rgba(47,41,38,0.08)] transition-all duration-300 min-h-[95px] flex flex-col justify-between animate-fadeIn cursor-default">
    ...
    <div className="relative z-10 flex justify-between items-start w-full">
      <p className="text-[10px] font-bold text-[#7a8b95] uppercase tracking-widest">{label}</p>
      <div className="w-8 h-8 rounded-lg border flex items-center justify-center shrink-0 shadow-sm transition-all" style={{backgroundColor: `${colorAccent}10`, borderColor: `${colorAccent}20`, color: colorAccent}}>
        <IconComp size={15} />
      </div>
    </div>
    <div className="relative z-10 mt-1 flex items-end justify-between">
      <p className="text-[22px] font-black leading-none text-[#212c46]" style={{color: colorValue}}>{value}</p>
...
export default function JobOpenings() {
  ...
  return (
    <div className="flex flex-1 w-full flex-col animate-fadeIn bg-transparent space-y-4">
      ...
      <div className="px-4 sm:px-8 w-full mt-[2px] pb-8 mb-8">
        <div className="w-full space-y-4">
          {/* KPI CARDS COMPACT & LEAN */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 shrink-0">
            <KpiCard label="Total Openings" value={kpiData.total} icon={Briefcase} colorAccent={THEME.primary} colorValue={THEME.primary} desc={`All Registered`} />
            <KpiCard label="Active (Published)" value={kpiData.active} icon={Globe} colorAccent={THEME.success} colorValue={THEME.success} desc="Live Careers Page" />
            <KpiCard label="Total Applications" value={kpiData.totalApps} icon={Users} colorAccent={THEME.skyBlue} colorValue={THEME.primary} desc="Candidate Inflow" />
            <KpiCard label="Drafts Pending" value={kpiData.drafts} icon={FileText} colorAccent={THEME.gold} colorValue={THEME.primary} desc="Awaiting Review" />
          </div>

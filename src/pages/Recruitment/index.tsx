...
// --- Local compact KPI Card ---
const LocalKpiCard = ({ icon: IconComp, value, label, colorAccent, colorValue, desc }: any) => (
  <div className="bg-white/90 px-5 py-4 rounded-2xl border border-[#eaeaec] shadow-sm flex-1 min-w-[200px] relative overflow-hidden group hover:border-[#b58c4f]/50 transition-all min-h-[90px] flex flex-col justify-between animate-fadeIn select-none">
    <div className="absolute -right-4 -bottom-6 opacity-[0.05] transform group-hover:scale-110 transition-transform duration-700 pointer-events-none z-0">
      <IconComp size={90} style={{ color: colorAccent }} />
    </div>
...
// --- User Guide Panel (Identical style to UserPermissions Guide) ---
    ...
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-white shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-4 border-[#709654] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#709654] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-[15px]"><UserCheck size={20} className="text-[#709654]"/> RECRUITMENT ATS GUIDE</h3>
            <p className="text-[11px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1">คู่มือการใช้งานระบบติดตามผู้สมัครงาน</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[13px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#eaeaec] pb-2 font-mono">
              <Inbox size={18} className="text-[#709654]"/> 1. Talent Kanban Pipelines
            </h4>
            <p className="text-[12px] mb-3">ระบบบริหารจัดการและประเมินผลสถานะผู้สมัครอย่างเป็นขั้นตอนเพื่อประสิทธิภาพในการคัดสรรบุคคล:</p>
            <ul className="list-none pl-0 space-y-3">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <Inbox size={16} className="shrink-0 text-[#212c46] mt-0.5"/> 
                <div><strong className="text-[#212c46]">Applied:</strong> ใบสมัครที่ส่งเข้ามาในระบบ เพื่อรับการตรวจสอบเอกสารและพิจารณาขั้นต้น</div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <Clock size={16} className="shrink-0 text-[#3f809e] mt-0.5"/> 
                <div><strong className="text-[#3f809e]">Interview:</strong> ผ่านด่านแรกเข้าสู่การสอบสัมภาษณ์โดยกรรมการของแต่ละแผนก</div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <Send size={16} className="shrink-0 text-[#b58c4f] mt-0.5"/> 
                <div><strong className="text-[#b58c4f]">Offered:</strong> นัดตกลงยื่นข้อเสนอสวัสดิการ อัตราเงินเดือน และวันเริ่มทำงานหลัก</div>
              </li>
              <li className="flex items-start gap-2 bg-[#508660]/10 p-3 rounded-xl border border-[#508660]/30">
                <CheckCircle2 size={16} className="shrink-0 text-[#508660] mt-0.5"/> 
                <div><strong className="text-[#508660]">Hired:</strong> สิ้นสุดด่านคัดสรรและอนุมัติรับเข้าทำงาน ระบบจะจัดส่งข้อมูลเข้า Dashboard หลักโดยอัตโนมัติ</div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[13px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#eaeaec] pb-2 font-mono">
              <ShieldCheck size={18} className="text-[#709654]"/> 2. Advanced Security Settings
            </h4>
            <p className="text-[12px] mb-3">ระบบมาตรฐานความปลอดภัยและการควบคุมข้อมูลเชื่อมโยงรูปแบบ User Permissions:</p>
            <ul className="list-disc pl-5 mt-2 space-y-2 text-[12px]">
              <li><strong className="text-[#932c2e]">Global Recruitment Lock:</strong> ปิดระงับการเปลี่ยนแปลงผู้สมัครหรือการเสนอตำแหน่งงานทันใจ มีผลครอบคลุมทั้งระบบความลับ</li>
              <li><strong className="text-[#657f4d]">Auto-Approve Sync:</strong> เมนูอนุมัติความต้องการกำลังคน (Manpower Requests) ให้เปลี่ยนเป็นตำแหน่งงานโดยอัติโนมัติ</li>
              <li><strong className="text-[#212c46]">Assessment Tracking:</strong> ควบคุมคะแนนประเมิน (Assessment score) โดยต้องไม่เกินเกณฑ์ความปลอดภัยสูงสุดในโครงข่ายข้อมูล</li>
            </ul>
          </section>
          
          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[13px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#eaeaec] pb-2 font-mono">
              <Sliders size={18} className="text-[#b58c4f]"/> 3. Global ATS Sync
            </h4>
            <p className="text-[12px]">การประมวลผลและการซิงโครไนซ์ข้อมูลทั้งหมด ทำงานแบบ Real-time ร่วมกับ Google Sheets และจัดเตรียมรายการสรุปสำหรับผู้บริหารเพื่อตรวจสอบสถิติที่เหมาะสม</p>
          </section>
        </div>
...
export default function Recruitment() {
  ...
  return (
    <div className="flex flex-1 w-full flex-col animate-fadeIn bg-transparent space-y-4 select-none">
      ...
      <div className="px-4 sm:px-8 w-full mt-[2px]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
          <LocalKpiCard label="Active Postings" value={stats.activeOpenings} icon={Briefcase} colorAccent="#3f809e" colorValue="#212c46" desc="Live Vacancies" />
          <LocalKpiCard label="Total Pipelines" value={candidates.length} icon={UserPlus} colorAccent="#212c46" colorValue="#212c46" desc="Enrolled Talents" />
          <LocalKpiCard label="Pending Approval" value={stats.pendingRequests} icon={Clock} colorAccent="#b58c4f" colorValue="#212c46" desc="Awaiting Actions" />
          <LocalKpiCard label="Successful Hires" value={stats.hired} icon={CheckCircle2} colorAccent="#657f4d" colorValue="#508660" desc="Joined Family" />
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-[#eaeaec] overflow-hidden flex flex-col animate-fadeIn">
          ...
          <div className="overflow-auto custom-scrollbar flex-1 bg-white min-h-[450px]">
            {isLoading ? (

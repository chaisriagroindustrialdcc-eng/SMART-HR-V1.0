...
const KpiCard = ({ icon: IconComp, value, label, colorAccent, colorValue, desc }: any) => (
  <div className="bg-white/90 px-4 py-3.5 rounded-2xl border border-[#eaeaec] shadow-sm flex-1 min-w-[200px] relative overflow-hidden group hover:border-[#b58c4f] transition-all min-h-[95px] flex flex-col justify-between animate-fadeIn">
    <div className="absolute -right-4 -bottom-6 opacity-[0.05] transform group-hover:scale-110 transition-transform duration-700 pointer-events-none">
      <IconComp size={85} color={colorAccent} />
    </div>
    ...
    <div className="relative z-10 mt-1 flex items-end justify-between">
      <p className="text-[22px] font-black leading-none text-[#212c46] font-mono" style={{color: colorValue}}>
        {value}
      </p>
    ...
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-white shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-2 border-[#b58c4f] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#b58c4f] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-lg"><Icons.BookOpen size={22} className="text-[#b58c4f]"/> PAYSLIP GUIDE (HR)</h3>
            <p className="text-[12px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1.5">Management & Clearance Authorization</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white font-sans">
          <section className="animate-fadeIn">
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Icons.ShieldCheck size={18} className="text-[#b58c4f]"/> 1. Centralized Payroll Sync
            </h4>
            <p className="text-[12px] mb-3">ระบบบริหารสลิปเงินเดือนของฝั่งเจ้าหน้าที่ HR ทำงานแบบเชื่อมสัมฤทธิ์สมบูรณ์ (Fully Unified Engine):</p>
            <ul className="list-none pl-0 space-y-3">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <Icons.Layers size={16} className="shrink-0 text-[#3f809e] mt-0.5"/> 
                <div><strong className="text-[#3f809e]">Calculated State Sync:</strong> ดึงค่าผลลัพธ์สรุปมาจากโมดูลประมวลผล (Payroll Calculation) ที่ได้รับการจัดโครงอัตโนมัติ</div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <Icons.Lock size={16} className="shrink-0 text-[#212c46] mt-0.5"/> 
                <div><strong className="text-[#212c46]">Confidential Nodes:</strong> รองรับการใส่ Passcode ล็อกไฟล์ส่วนตัวด้วยรหัส 4 หลักเพื่อความปลอดภัยสูงสุดในการ disburse สารสนเทศทางบัญชี</div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Icons.Sliders size={18} className="text-[#a94228]"/> 2. Workflow Release Pipelines
            </h4>
            <p className="text-[12px] mb-3">สลิปเงินเดือนมีกระบวนการตรวจสอบและอัปเดต 3 ระดับความปลอดคลังหลัก:</p>
            <ol className="list-decimal pl-5 mt-2 space-y-2 text-[12px]">
              <li><strong className="text-[#7a8b95]">Draft:</strong> เพิ่งผ่านการ sync คำนวณเบื้องต้น รอการตรวจสอบปรับแก้ยอด หรือการเพิ่ม Bonus/Incentive เพิ่มเติม</li>
              <li><strong className="text-[#3f809e]">Approved:</strong> ผ่านการสอบทานความถูกต้องและลงความเห็นจาก HR Verifier เรียบร้อยแล้ว พร้อมส่งจ่ายตรงงวด</li>
              <li><strong className="text-[#657f4d]">Sent (Publish):</strong> ปล่อยให้พนักงานเข้ารับทราบ เรียกพิมพ์คลัง หรือ download ผ่าน Secure Individual Roster Portal</li>
            </ol>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Icons.Smartphone size={18} className="text-[#657f4d]"/> 3. Delivery Mechanics
            </h4>
            <p className="text-[12px]">เมื่อตั้งค่าให้เป็นสถานะ <b>Sent</b> พนักงานจะสามารถเรียกรายงาน PDF สลิปเงินเดือนได้ทันทีแบบกึ่งเวลาจริง โดยการตั้งค่าพารามิเตอร์ด้านภาษี ประกันสังคม และสัดส่วนสะสมจะอิงตาม Access Configuration ด้านขวา</p>
          </section>
        </div>
      ...
      <div className="px-4 sm:px-8 w-full mt-[2px]">
        <div className="w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-3 shrink-0">
                <KpiCard label="ACTIVE PERSONNEL" value={totalRoster} icon={Icons.Users} colorAccent={THEME.palette.navyBlue} colorValue={THEME.primary} desc="Roster Database" />
                <KpiCard label="DRAFTS IN WAIT" value={draftCount} icon={AlertTriangle} colorAccent={draftCount > 0 ? THEME.palette.coral : THEME.palette.olive} colorValue={draftCount > 0 ? THEME.palette.coral : THEME.primary} desc="Unverified Sheets" />
                <KpiCard label="APPROVED REGISTERS" value={approvedCount} icon={CheckCircle2} colorAccent={THEME.palette.olive} colorValue={THEME.palette.olive} desc="Ready to Publish" />
                <KpiCard label="MONTHLY OUTFLOW" value={formatCurrency(totalNetOutflow)} icon={Banknote} colorAccent={THEME.palette.cerulean} colorValue={THEME.palette.cerulean} desc="THB Disbursal" />
            </div>

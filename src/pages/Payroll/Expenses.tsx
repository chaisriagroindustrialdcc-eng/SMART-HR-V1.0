...
const KpiCard = ({ icon: IconComp, value, label, colorAccent, desc }: { icon: any, value: any, label: string, colorAccent: string, desc: string }) => (
  <div className="bg-white/95 backdrop-blur-md px-5 py-4 rounded-[18px] border border-[#939885]/20 shadow-[0_4px_20px_rgba(47,41,38,0.02)] flex-1 min-w-[200px] relative overflow-hidden group hover:border-[#b22026]/40 hover:shadow-[0_6px_25px_rgba(47,41,38,0.06)] transition-all duration-300 flex flex-col justify-between animate-fadeIn">
    ...
    <div className="relative z-10 flex justify-between items-start w-full">
      <p className="text-[10px] font-black text-[#606a5f] uppercase tracking-widest">{label}</p>
...
// High-detail User Guide Panel matching User Permissions style
  ...
  return createPortal(
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-[#f3f3f1] shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-4 border-[#b22026] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="bg-[#212c46] px-6 py-5 flex justify-between items-center text-[#f3f3f1] shrink-0 border-b-2 border-[#b22026] relative z-10">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 bg-gradient-to-tr from-[#b58c4f] to-[#f3e5ab] rounded-xl flex items-center justify-center text-[#212c46] shadow-inner p-[2px]">
                <div className="w-full h-full bg-[#0F172A] rounded-[10px] flex items-center justify-center">
                    <Wallet size={18} className="text-[#b22026]"/>
                </div>
            </div>
            <div>
              <h3 className="text-sm font-black flex items-center gap-2 uppercase tracking-widest leading-none mb-1 drop-shadow-sm">EXPENSES MANAGEMENT GUIDE</h3>
              <p className="text-[10px] font-bold text-[#748b9e] uppercase tracking-widest mt-1 drop-shadow-sm">คู่มือวิเคราะห์และอนุมัติใบเบิกค่าใช้จ่ายบริษัท</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-6 text-[#414757] text-[12px] leading-relaxed bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <BookOpen size={16} className="text-[#b22026]"/> 1. Expense Claims Node (ระบบประมวลผลคำเบิกจ่าย)
            </h4>
            <p className="mb-2 text-[#414757] font-medium text-[11.5px]">จัดเก็บและตรวจสอบข้อมูลใบสำคัญการจ่ายเงินของบุคลากรภายในองค์กรอย่างมีหลักเกณฑ์ ประกอบด้วยหมวดหมู่:</p>
            <ul className="space-y-2 list-none pl-0 text-[11px] font-medium text-[#606a5f]">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-2.5 rounded-xl border border-[#eaeaec]">
                <Car size={16} className="shrink-0 text-[#3f809e] mt-1"/>
                <div>
                  <strong>Travel & Accommodation Rules:</strong> ตรวจสอบสิทธิ์การเดินทาง ค่าพาหนะ (Taxi) และค่าใช้จ่ายโรงแรมต่างจังหวัดในการปฏิบัติงานนอกสถานที่
                </div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-2.5 rounded-xl border border-[#eaeaec]">
                <Coffee size={16} className="shrink-0 text-[#b58c4f] mt-1"/>
                <div>
                  <strong>Meals & Supplies Verification:</strong> ควบคุมวงเงินสิทธิ์ค่ารับรองความบันเทิง เลี้ยงรับรองลูกค้า ตลอดจนของใช้วัสดุสิ้นเปลืองเร่งด่วนในสำนักงาน
                </div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <CheckCircle2 size={16} className="text-[#b22026]"/> 2. Configuration Audit Level (ขั้นตอนการอนุมัติ)
            </h4>
            <div className="bg-[#fff5f5] p-3.5 rounded-2xl border border-[#ffe3e3] space-y-2 text-[11px] text-[#606a5f] font-medium">
              <p className="text-[#b22026] font-black uppercase flex items-center gap-1.5"><ShieldCheck size={14}/> Node States Overview: </p>
              <p>• <strong>Pending:</strong> รายการเบิกส่งเข้าระบบเรียบร้อย อยู่ในสถานะรอฝ่ายบุคคลหรือหัวหน้างานประเมินใบเสร็จแนบจริง</p>
              <p>• <strong>Approved:</strong> ผ่านมาตรฐานประเมิน ได้รับอนุมัติเรียบร้อยและส่งข้อมูลเข้าเตรียมการจ่ายเงินโดยฝ่ายการเงิน</p>
              <p>• <strong>Paid:</strong> จ่ายเงินเรียบร้อย ฝ่ายการเงินโอนเงินสดชดเชยเข้าบัญชีบุคลากรปลายทางผู้ยื่นเรียบร้อยเสร็จสมบูรณ์</p>
              <p>• <strong>Rejected:</strong> เอกสารไม่พึงประสงค์ วงเงินผิดเงื่อนไข หรือขาดหลักฐานการเบิกจ่ายสำคัญ เช่น ใบเสร็จตัวจริง</p>
            </div>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Key size={16} className="text-[#b58c4f]"/> 3. Permission System Integration (มาตรฐานการตั้งค่าสิทธิ์)
            </h4>
            <div className="grid grid-cols-1 gap-2.5">
              {[
                { icon: Pencil, label: 'Claims Configuration Panel', desc: 'หน้าต่างกำหนดข้อมูลสิทธิ์ 3 ระดับโครงสร้าง (Profile, Details, Approval status) สอดคล้องตามเกณฑ์มาตรฐานระบบ User Permissions ขององค์กร', color: '#b58c4f' },
                { icon: ShieldCheck, label: 'Expense Audit Compliance Secure', desc: 'ข้อมูลความปลอดภัยทางการเงิน ใบเสร็จ และรายจ่ายองค์กรถูกเข้ารหัสความลับป้องกันการประเมินทุจริตและการรั่วไหลข้อมูลส่วนบุคคล', color: '#b22026' },
              ].map((btn, idx) => (
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.3s' }}>
             <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
               <RefreshCw size={16} className="text-[#3f809e]"/> 4. Real-time Database Sync (การซิงค์ข้อมูลตามเวลาจริง)
             </h4>
             <p className="bg-[#3f809e]/5 text-[#2f2926] p-3 rounded-xl border border-[#3f809e]/20 font-medium text-[11px] leading-relaxed">
               ตัวเลขสะสมทั้งหมดจะถูกซิงก์ประมวลผลเพื่อนำทางงบประมาณประจำทีมและระเบียบสลักเงินเดือนของพนักงาน เพื่อคำนวณหักลบยอดจ่ายจริงสำหรับการวิเคราะห์และประเมินงบประมาณขององค์กรได้ทันที
             </p>
          </section>
        </div>
      ...
      <div className="px-4 sm:px-8 w-full mt-[2px]">
        <div className="w-full animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-3 shrink-0">
                <KpiCard label="Total Expense Claims" value={records.length} icon={Receipt} colorAccent={THEME.palette.brick} desc="Claims Count" />
                <KpiCard label="Pending Approval" value={pendingCount} icon={Activity} colorAccent={THEME.palette.red} desc="Action Required" />
                <KpiCard label="Approved Amount" value={`฿${formatCurrency(approvedTotal)}`} icon={CheckCircle2} colorAccent={THEME.palette.slate} desc="Awaiting Payment" />
                <KpiCard label="Paid Settlement" value={`฿${formatCurrency(paidTotal)}`} icon={Banknote} colorAccent={THEME.palette.forest} desc="Healthy Settlement" />
            </div>

            {/* MAIN DATA BLOCK */}
            <div className="bg-white/90 rounded-3xl shadow-lg border border-[#eaeaec] overflow-hidden flex flex-col transition-all">

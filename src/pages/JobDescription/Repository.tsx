...
// --- Synced Notification/Toast Component ---
...
// --- Massive Detailed User Guide Panel matching UserPermissions design ---
        ...
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#b7a159] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-lg">
              <BookOpen size={22} className="text-[#b7a159]"/> JD REPOSITORY GUIDE
            </h3>
            <p className="text-[12px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1.5">Job Description & Competencies</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <ShieldCheck size={18} className="text-[#b7a159]"/> 1. CENTRAL DATABASE MANAGEMENT
            </h4>
            <p className="text-[12px] mb-3 font-medium">JD Repository คือระบบศูนย์กลางควบคุมบทบาท หน้าที่ความรับผิดชอบ และคุณสมบัติที่จำเป็นของตำแหน่งงานภายในองค์กร:</p>
            <ul className="list-none pl-0 space-y-3">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <Database size={16} className="shrink-0 text-[#3f809e] mt-0.5"/> 
                <div>
                  <strong className="text-[#3f809e]">Single Source of Truth:</strong> เป็นฐานข้อมูลกลางเพื่อดึงไปใช้งานอัตโนมัติในโมดูล Manpower Request, ประกาศรับสมัครงาน (Job Openings) และระบบจัดการสิทธิ์พนักงาน
                </div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <Clock size={16} className="shrink-0 text-[#657f4d] mt-0.5"/> 
                <div>
                  <strong className="text-[#657f4d]">Version Control & ISO Support:</strong> บันทึกประวัติเวอร์ชันและวันที่แก้ไขล่าสุดอย่างครบถ้วน สนับสนุนเกณฑ์ประเมินและทวนสอบตามมาตรฐานคุณภาพระดับสากล ISO/GMP 9001:2015อย่างเคร่งครัด
                </div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <ListChecks size={18} className="text-[#b7a159]"/> 2. KEY REPOSITORY OPERATIONS
            </h4>
            <p className="text-[12px] mb-3 font-medium">คำอธิบายขั้นตอนการใช้ประโยชน์ทางด้านหน้าต่างตารางหลัก:</p>
            <div className="space-y-4 text-[11px] bg-slate-50 p-4 rounded-xl border border-slate-200">
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded bg-[#212c46] text-white flex items-center justify-center font-bold text-[10px] shrink-0">A</span>
                <div>
                  <p className="font-extrabold text-[#212c46] tracking-wide mb-0.5">การระบุรหัสเอกสาร (JD Code Standard):</p>
                  <p className="text-[#606a5f]">รหัสต้องสอดคล้องตามรูปแบบรหัสบริหารกำลังพลองค์กร เช่น <span className="font-tech text-[#a94228] font-bold">JD-IT-01</span> เพื่อให้ทุกแผนกอ้างอิงตรงกันในผังโครงสร้างองค์การ</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded bg-[#212c46] text-white flex items-center justify-center font-bold text-[10px] shrink-0">B</span>
                <div>
                  <p className="font-extrabold text-[#212c46] tracking-wide mb-0.5">การปรับปรุงและอัปโหลด PDF:</p>
                  <p className="text-[#606a5f]">สามารถดาวน์โหลดใบพรรณนาหน้าที่ออกเป็น PDF ฉบับราชการ และพนักงานลงนามเพื่อรับทราบเป้าหมายรวมถึง KPI ประจำปีได้ทันที</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded bg-[#212c46] text-white flex items-center justify-center font-bold text-[10px] shrink-0">C</span>
                <div>
                  <p className="font-extrabold text-[#212c46] tracking-wide mb-0.5">การคัดกรองและการจัดลำดับ:</p>
                  <p className="text-[#606a5f]">ใช้ตัวกรองตามส่วนงานและระดับความรับผิดชอบ (Staff, Supervisor, Manager) เพื่อเปรียบเทียบมาตรฐานทักษะพนักงานได้ถูกต้องรวดเร็ว</p>
                </div>
              </div>
            </div>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.15s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Lock size={18} className="text-[#932c2e]"/> 3. SECURITY & COMPLIANCE REGULATION
            </h4>
            <p className="text-[12px] font-bold text-[#2f2926] bg-[#932c2e]/10 border border-[#932c2e]/30 p-3 rounded-xl leading-relaxed">
              สิทธิ์ในการเข้าถึงและแก้ไข (Write/Edit Permission) ถูกอ้างสิทธิ์โดยตรงจากหน้าต่างสิทธิ์ผู้ใช้ (User Permissions) เพื่อความปลอดภัยสูงสุด ห้ามมิให้ผู้ไม่มีฐานอำนาจสิทธิ์ผู้บริหาร ทำการแก้ไขหรือลบฐานเอกสารสำคัญนี้โดยพลการ
            </p>
          </section>
        </div>
        
        {/* Guide Footer */}
        <div className="px-6 py-4 bg-slate-50 border-t border-[#eaeaec] flex justify-end shrink-0">
          <button onClick={onClose} className="px-6 py-2.5 bg-[#212c46] text-[#eaeaec] font-black rounded-xl uppercase text-[11px] hover:bg-[#b7a159] hover:text-white transition-all shadow-md tracking-widest border border-transparent">
            เข้าใจทั้งหมด (Acknowledge)
          </button>
        </div>
      </div>
    </>, document.body
...
// --- Lean KPI Card styled neatly for the overall view ---
const KpiCard = ({ iconName, value, label, colorAccent, colorValue, desc }: any) => {
  const IconComp = iconName === 'Briefcase' ? Briefcase :
                   iconName === 'ShieldCheck' ? ShieldCheck :
                   iconName === 'Building2' ? Building2 : Clock;
  return (
    <div className="bg-white px-5 py-4 rounded-xl border border-[#eaeaec] shadow-sm flex-1 min-w-[200px] relative overflow-hidden group hover:border-[#b7a159] transition-all min-h-[96px] flex flex-col justify-between animate-fadeIn cursor-default">
      <div className="absolute -right-4 -bottom-6 opacity-[0.05] transform group-hover:scale-110 transition-transform duration-700 pointer-events-none">
        <IconComp size={90} color={colorAccent} />
      </div>
      <div className="relative z-10 flex justify-between items-start w-full">
        <p className="text-[10px] font-bold text-[#7a8b95] uppercase tracking-[0.1em]">{label}</p>
      ...
      <div className="relative z-10 mt-1 flex items-end justify-between">
        ...
        <span className="text-[9px] font-bold text-[#4d5a44] uppercase tracking-wider flex items-center gap-1">
      ...
      <div className="px-4 sm:px-8 w-full mt-[2px]">
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-3 shrink-0">
            <KpiCard label="Managed Positions" value={isLoading ? '...' : kpiData.total} iconName="Briefcase" colorAccent={THEME.primaryLight} colorValue={THEME.primary} desc="Active Profiles" />
            <KpiCard label="ISO Approved (Active)" value={isLoading ? '...' : kpiData.active} iconName="ShieldCheck" colorAccent={THEME.success} colorValue={THEME.success} desc="Standard Verified" />
            <KpiCard label="Dept. Coverage" value={isLoading ? '...' : kpiData.depts} iconName="Building2" colorAccent={THEME.skyBlue} colorValue={THEME.primary} desc="Corporate Units" />
            <KpiCard label="Awaiting validation / Drafts" value={isLoading ? '...' : kpiData.drafts} iconName="Clock" colorAccent={THEME.gold} colorValue={THEME.primary} desc="Pending Audit" />
          </div>
          ...
          {/* Sizable gap separation from Footer as requested (mt-8 = 32px of distance value) */}
          <div className="mt-8 h-[1px] w-full bg-slate-200/50"></div>

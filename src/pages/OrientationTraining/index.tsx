...
// Standardized KpiCard with beautiful micro-shadows matching UserPermissions
...
export default function OrientationTraining() {
  ...
  return (
    <div className="min-h-screen text-[#212c46] font-sans px-4 sm:px-8 pb-12 animate-fadeIn selection:bg-[#709654]/30">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <LocalKpiCard 
          ...
          colorValue="#212c46"
          desc="คู่บัดดี้ประกบใจ" 
        />
      </div>

      {/* 5. Central Unified Console Container */}
      <div className="bg-white rounded-2xl border border-[#eaeaec] shadow-sm overflow-hidden mb-8">
        ...
        {activeTab === 'journey' && (
          <div className="p-4 sm:p-6 bg-[#fcfcfb]/40">
            ...
            <div className="bg-[#133041] rounded-2xl p-6 md:p-8 text-white relative overflow-hidden shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 border border-white/5 animate-fadeIn">
      ...
      <div className="bg-[#f8f9fa] rounded-2xl border border-[#eaeaec] p-6 mb-8 relative overflow-hidden">
...
// --- SUB-COMPONENTS & DRAWER DIALOG SOLUTIONS ---
...
function UserGuidePanel({ isOpen, onClose }: any) {
  ...
  return createPortal(
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-white shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-2 border-[#709654] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#709654] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-base"><Icons.BookOpen size={20} className="text-[#b58c4f]"/> ORIENTATION TRAINING GUIDE</h3>
            <p className="text-[11px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1.5">Learning Pathway and Coaching</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white font-sans">
          
          <section className="animate-fadeIn">
            <h4 className="text-[13px] font-black text-[#212c46] mb-2.5 uppercase flex items-center gap-2 border-b border-[#eaeaec] pb-1.5 font-sans">
              <Icons.Award size={16} className="text-[#709654]"/> 1. หลักสูตรปฐมนิเทศ (Training Batches)
            </h4>
            <p className="text-[11.5px] leading-relaxed text-[#414757]">
              การจัดการเตรียมปฐมนิเทศ เป็นการปรับวิสัยทัศน์พนักงานใหม่ของทางองค์กร ให้สอดรับกับนโยบาย ระเบียบบริษัท และระบบความปลอดภัยด้านไอที โดยฝ่ายทรัพยากรบุคคล (HR Node) สามารถ:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1.5 text-[11.5px] text-[#414757] font-bold">
              <li>สร้าง/แก้ไข หลักสูตรรุ่นปฐมนิเทศ และกำหนดวิทยากรพี่เลี้ยงหลัก</li>
              <li>ติดตามจำนวนผู้เข้าร่วมสะสม และใส่คะแนนสอบเกณฑ์ประเมินท้ายหลักสูตร</li>
              <li>ปรับสเตตัส Draft, Scheduled, In Progress, และ Completed</li>
            </ul>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[13px] font-black text-[#212c46] mb-2.5 uppercase flex items-center gap-2 border-b border-[#eaeaec] pb-1.5 font-sans">
              <Icons.ShieldAlert size={16} className="text-[#b58c4f]"/> 2. ระบบพี่เลี้ยงประกบเพื่อนใหม่ (Buddy Mentoring Node)
            </h4>
            <p className="text-[11.5px] leading-relaxed text-[#414757]">
              ทักษะทางเทคนิคและการรับวัฒนธรรมจะราบรื่นขึ้นด้วยการประกบคู่พี่เลี้ยงประจำเป็นเวลา 3 - 6 เดือนแรก:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1.5 text-[11.5px] text-[#414757] font-bold">
              <li>พี่เลี้ยงทำหน้าที่ประสาน ชวนพูดคุย สอนการใช้งาน หรือระบบในสายงาน</li>
              <li>การบันทึกจำนวนครั้งที่เข้าพบร่วม (Meetings Log)</li>
              <li>บันทึกคะแนนการเรียนรู้ / ผลความเข้ากันของกลุ่มพนักงาน</li>
            </ul>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[13px] font-black text-[#212c46] mb-2.5 uppercase flex items-center gap-2 border-b border-[#eaeaec] pb-1.5 font-sans">
              <Icons.FolderOpen size={16} className="text-[#3f809e]"/> 3. สื่อการอบรม & คลังไฟล์ (Isolated Libraries)
            </h4>
            <p className="text-[11.5px] text-[#414757]">
              แหล่งเอกสารบลูพริ้นท์ออนดีมานด์ วีดีโดบทเรียน หรือสิทธิประโยชน์นโยบาย พนักงานใหม่สามารถเรียกเปิดอ่านประกอบศึกษาพหุเรียนรู้ได้ทุกค่ำตลอดรอบทดลองงาน
            </p>
          </section>
        ...
        <div className="p-4 bg-[#f8f9fa] border-t border-[#eaeaec] flex justify-end shrink-0">
          <button onClick={onClose} className="px-8 py-2.5 bg-[#212c46] text-white font-black rounded-xl uppercase text-[11px] hover:bg-[#414757] transition-all shadow-md tracking-[0.1em] cursor-pointer">รับทราบข้อมูล / Got it</button>
        </div>
      </div>
    </>, document.body
  );

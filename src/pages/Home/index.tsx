                        ...
                        return (
                            <GlassCard key={w.id} className="relative flex flex-col justify-between border-[#eaeaec]/60 overflow-hidden min-h-[380px]" hoverEffect={true}>
                                <div className="space-y-3 flex-1 flex flex-col">
                                    ...
                                    {w.showSettings && (
                                        <div className="p-2.5 bg-slate-50 border border-slate-100 rounded-xl space-y-2 animate-fadeIn text-[10px] shrink-0">
          ...
          {selectedNews && (
             <>
                ...
                <div className="p-6 overflow-y-auto custom-scrollbar">
                  <div className="whitespace-pre-wrap text-[#4a5568] text-sm leading-relaxed mb-8 font-medium">

...
const KpiCard = ({ icon, value, label, colorAccent, colorValue, desc }: any) => (
  <div className="bg-white/95 px-6 py-5 rounded-2xl border border-[#eaeaec] shadow-sm flex-1 min-w-[220px] relative overflow-hidden group hover:border-[#b7a159] transition-all min-h-[110px] flex flex-col justify-between animate-fadeIn">
    ...
    <div className="relative z-10 mt-2 flex items-end justify-between">
      <p className="text-[26px] font-black leading-none text-[#212c46]" style={{color: colorValue}}>
        {value}
      </p>
      <span className="text-[10px] font-bold text-[#4d87a8] uppercase tracking-wider flex items-center gap-1">
...
// --- Floating User Guide Panel (Standard as User Permissions) ---
    ...
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-white shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-2 border-[#b7a159] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#b7a159] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-lg"><Icons.BookOpen size={22} className="text-[#b7a159]"/> OVERTIME REGULATION GUIDE</h3>
            <p className="text-[11px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1.5">Thai Labour Protection Act Compliance</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[13px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Icons.ShieldAlert size={18} className="text-[#b7a159]"/> 1. Overtime Legal Thresholds
            </h4>
            <p className="text-[12px] mb-3">ตามพระราชบัญญัติคุ้มครองแรงงาน พ.ศ. 2541 และฉบับแก้ไข การกำหนดการทำงานล่วงเวลา (OT) มีข้อจำกัดทางกฎหมายที่เคร่งครัดดังนี้:</p>
            <ul className="list-none pl-0 space-y-3">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-3 rounded-xl border border-[#eaeaec]">
                <Icons.Clock size={16} className="shrink-0 text-amber-600 mt-0.5"/> 
                <div><strong className="text-amber-700">ชั่วโมงล่วงเวลารวม:</strong> สัปดาห์หนึ่งต้องไม่เกิน <b>36 ชั่วโมง</b> สำหรับงานทั่วไป หากรวมงานวันหยุดด้วย</div>
              </li>
              <li className="flex items-start gap-2 bg-[#932c2e]/10 p-3 rounded-xl border border-[#932c2e]/30">
                <Icons.Coffee size={16} className="shrink-0 text-[#932c2e] mt-0.5"/> 
                <div><strong className="text-[#932c2e]">สิทธิ์พักก่อนสแกนเริ่ม:</strong> ต้องจัดให้มีเวลาพักไม่น้อยกว่า <b>20 นาที</b> ก่อนเริ่มทำโอทีอย่างน้อย 2 ชั่วโมง</div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[13px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Icons.PieChart size={18} className="text-emerald-700"/> 2. Rate Multipliers (อัตราค่าล่วงเวลา)
            </h4>
            <p className="text-[12px] mb-3">อัตราการคำนวณเงินค่าโอที มีรูปแบบคูณพหุคูณแยกแยะตามข้อบังคับทางกฎหมาย:</p>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg">
                <span className="font-bold text-[#212c46] block">วันธรรมดา (Regular OT)</span>
                <span className="text-[#4d87a8] font-black text-sm">1.5 เท่า</span>
                <span className="text-slate-400 block text-[10px]">สำหรับชั่วโมงที่ล้นเวลาหลังเลิกงาน</span>
              </div>
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg">
                <span className="font-bold text-[#212c46] block">วันหยุด (Holiday Normal)</span>
                <span className="text-[#657f4d] font-black text-sm">1.0 / 2.0 เท่า</span>
                <span className="text-slate-400 block text-[10px]">ตามประเภทพนักงาน (รายเดือน / รายวัน)</span>
              </div>
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg col-span-2">
                <span className="font-bold text-[#212c46] block">วันหยุดล่วงเวลา (Holiday OT)</span>
                <span className="text-[#a94228] font-black text-sm">3.0 เท่า</span>
                <span className="text-slate-400 block text-[10px]">ชั่วโมงล่วงเวลาที่ทำในวันหยุดนักขัตฤกษ์หรือวันหยุดประจำสัปดาห์</span>
              </div>
            </div>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[13px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Icons.RefreshCw size={18} className="text-[#3f809e]"/> 3. Dual-Approval & Verification Status
            </h4>
            <p className="text-[12px]">ระบบโอทีรองรับหลักการ 3 ขั้นตอน: ผู้จัดการวางแผนชั่วโมงใช้งาน (<b>Planned Hrs</b>) พนักงานลงเวลาปฏิบัติจริง (<b>Actual Hrs</b>) และฝ่ายประมวลผลอนุมัติ (<b>Approve / Verify</b>) เพื่อทำการออกสลิปจ่ายเงินเดือนอัตโนมัติแบบไร้รอยต่อ</p>
          </section>
        </div>
        
        <div className="p-4 bg-[#f8f9fa] border-t border-[#eaeaec] flex justify-end shrink-0">
          <button onClick={onClose} className="px-8 py-2.5 bg-[#212c46] text-white font-black rounded-xl uppercase text-[11px] hover:bg-[#414757] hover:text-white transition-all shadow-md tracking-[0.1em]">Got It (เข้าใจแล้ว)</button>
        </div>
      </div>
    </>, document.body
  );
    ...
    <div className="flex flex-1 w-full flex-col animate-fadeIn bg-transparent space-y-4">
      ...
      <div className="px-8 w-full mt-[2px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 shrink-0">
          <KpiCard label="Pending Approval" value={kpis.pending} icon="clock" colorAccent={THEME.skyBlue} colorValue={THEME.primary} desc="Awaiting Actions" />
          <KpiCard label="Planned Cum. Hrs" value={kpis.totalPlanned} icon="clipboard-list" colorAccent={THEME.gold} colorValue={THEME.primary} desc="Scheduled Forecast" />
          <KpiCard label="Actual Clocked Hrs" value={kpis.totalActual} icon="timer" colorAccent={THEME.success} colorValue={THEME.primary} desc="Real Attendance" />
          <KpiCard label="Cost Variance Difference" value={`${kpis.variance} Hrs`} icon="alert-circle" colorAccent={Number(kpis.variance) > 0 ? THEME.accent : THEME.success} colorValue={Number(kpis.variance) > 0 ? THEME.accent : THEME.success} desc="Variance Delta" />
        </div>
      ...
      >
        <div className="p-6 bg-[#f8f9fa] flex-1 flex flex-col overflow-hidden max-h-[500px]">
          {conflictedRows > 0 && (
            <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl mb-4 flex items-center gap-2.5 shrink-0 text-amber-700 animate-fadeIn">
          ...
          <div className="flex-1 overflow-auto rounded-xl border border-[#eaeaec] bg-white">

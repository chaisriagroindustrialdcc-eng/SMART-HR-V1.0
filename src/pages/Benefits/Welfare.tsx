...
// Lean and ultra polished compact KPI Card matching Turnover.tsx style
          ...
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 bg-gradient-to-tr from-[#b58c4f] to-[#f3e5ab] rounded-xl flex items-center justify-center text-[#212c46] shadow-inner p-[2px]">
                <div className="w-full h-full bg-[#0F172A] rounded-[10px] flex items-center justify-center">
                    <HeartHandshake size={18} className="text-[#b22026]"/>
                </div>
            </div>
            <div>
              <h3 className="text-sm font-black flex items-center gap-2 uppercase tracking-widest leading-none mb-1 drop-shadow-sm">WELFARE MANAGEMENT GUIDE</h3>
              <p className="text-[10px] font-bold text-[#748b9e] uppercase tracking-widest mt-1 drop-shadow-sm">คู่มือวิเคราะห์และอนุมัติการเบิกสวัสดิการพนักงาน</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-6 text-[#414757] text-[12px] leading-relaxed bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <BookOpen size={16} className="text-[#b22026]"/> 1. Welfare Registry Node (ระบบศูนย์ข้อมูลการเบิกจ่าย)
            </h4>
            <p className="mb-2 text-[#414757] font-medium text-[11.5px]">บันทึกคำขอแบ่งตามหมวดหมู่สวัสดิการของพนักงานในองค์กรอย่างถูกต้อง ครอบคลุมวงเงินสิทธิ์:</p>
            <ul className="space-y-2 list-none pl-0 text-[11px] font-medium text-[#606a5f]">
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-2.5 rounded-xl border border-[#eaeaec]">
                <Stethoscope size={16} className="shrink-0 text-[#3f809e] mt-1"/>
                <div>
                  <strong>Medical Claim Control:</strong> จัดแจงวงเงินค่ารักษาพยาบาลทั้งกรณีผู้ป่วยนอก (OPD) และผู้ป่วยใน (IPD) เพื่อความโปร่งใส
                </div>
              </li>
              <li className="flex items-start gap-2 bg-[#f8f9fa] p-2.5 rounded-xl border border-[#eaeaec]">
                <Glasses size={16} className="shrink-0 text-[#b58c4f] mt-1"/>
                <div>
                  <strong>Dental & Optical Welfare:</strong> ควบคุมเพดานสิทธิ์การทำฟันและตัดแว่นสายตาประจำปีของพนักงานรายบุคคล
                </div>
              </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <CheckCircle2 size={16} className="text-[#b22026]"/> 2. Review & Audits Process (ขั้นตอนและสถานะคำขอ)
            </h4>
            <div className="bg-[#fff5f5] p-3.5 rounded-2xl border border-[#ffe3e3] space-y-2 text-[11px] text-[#606a5f] font-medium">
              ...
              <p>• <strong>Pending:</strong> คำขอเบิกส่งเข้ามาในระบบเรียบร้อย รอฝ่ายบุคคลผู้มีอธิปัตย์ตรวจสอบความถูกต้องและใบเสร็จแนบ</p>
              <p>• <strong>Approved:</strong> ผ่านมาตรฐานประเมิน ได้รับความเห็นชอบและเข้าเตรียมการบัญชีสั่งจ่ายโอนออก (Paid)</p>
              <p>• <strong>Rejected:</strong> เอกสารไม่พึงประสงค์ วงเงินเกินเพดานสิทธิ์ หรือหลักฐานการเงินสูญหาย (จำเป็นต้องป้อนเหตุผลแนะแนวพนักงาน)</p>
            </div>
          </section>

          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Key size={16} className="text-[#b58c4f]"/> 3. Configuration Management (โครงสร้างสิทธิ์การตั้งค่า)
            </h4>
            <div className="grid grid-cols-1 gap-2.5">
              {[
                { icon: Pencil, label: 'Claims Verification Node', desc: 'หน้าต่างป้อนรายละเอียด 3 ระดับคัดกรอง (Profile, Benefit, Approval status) สอดคล้องตามมาตรฐาน User Permissions', color: '#b58c4f' },
                { icon: ShieldCheck, label: 'PDPA Security & Confidential Protection', desc: 'ข้อมูลประวัติการรักษาพยาบาลและภาพรวมใบเสร็จสุขภาพถูกจัดเก็บภายใต้ข้อบัญญัติความเป็นส่วนตัวและความมั่นคงของระเบียบบริษัท', color: '#b22026' },
              ].map((btn, idx) => (
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.3s' }}>
             <h4 className="text-[13px] font-black text-[#2f2926] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
               <RefreshCw size={16} className="text-[#3f809e]"/> 4. Real-time System Sync
             </h4>
             <p className="bg-[#3f809e]/5 text-[#2f2926] p-3 rounded-xl border border-[#3f809e]/20 font-medium text-[11px] leading-relaxed">
               การอัปเดตสถานะทางการเงิน (โอนจ่ายสำเร็จ / ยกเลิกคำขอ) จะถูกซิงค์เข้าระบบประวัติพนักงานโดยรวมเพื่อรวบรวมตัวเลขหักทอน และคำนวณวงเงินคงเหลือของสปอนเซอร์องค์กรทันที
             </p>
          </section>
        </div>
      ...
      <div className="px-4 sm:px-8 w-full mt-[2px]">
        <div className="w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-3 shrink-0">
                <KpiCard label="Total Claims" value={records.length} icon={Receipt} colorAccent={THEME.palette.brick} desc="Welfare Records" />
